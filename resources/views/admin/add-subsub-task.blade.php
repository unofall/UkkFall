    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form  @if (Auth::user()->level === 'Admin') action="/create-subSubtask/{{ $task->id }}"
                        @elseif (Auth::user()->level === 'Member')
                        action="/member/create-subSubtask/{{ $task->id }}"  @endif method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="input-2">Event</label>
                            <input type="text" class="form-control input-square" id="input-1" placeholder="Input Name Event" value="{{ $task->events->name }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" name="task_idtasks" id="input-1" placeholder="Input name task" value="{{ $task->name }}" disabled >
                        </div>
                        <div class="d-flex justify-content-end mt-2 mr-2">
                            <button type="button" class="btn btn-primary " onclick="addCriteria()"><li class="la la-plus"></li></button>
                        </div>
                        ...
                        <div id="criteria-container">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-square" name="name[]" id="input-1" placeholder="Input Sub Task">
                            </div>
                            <div class="form-group">
                                <label for="input-3">Description</label>
                                <textarea id="" cols="30" rows="7" id="input-3" name="description[]" class="form-control input-square"></textarea>
                            </div>
                        </div>
