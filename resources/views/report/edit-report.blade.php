        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            @if (Auth::user()->level === 'Admin') action="/report/update/{{ $report->id }}"
                        @elseif (Auth::user()->level === 'Member')
                        action="/member/report/update/{{ $report->id }}" @endif
                            method="POST">
                            @csrf
