                ...
                <div class="card-body">
                    <form action="/report/update/{{ $report->id }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" name="" id="squareInput" placeholder="Input Name Event" value="{{ $task->name }}" disabled>

                            <input type="hidden" name="task_idtasks" value="{{ $task->id }}">
                        </div>
                        <div class="form-group">
                            <label for="squareInput"> Name Report</label>
                            <input type="text" class="form-control input-square" name="name[]" id ="squareInput" placeholder="Input Name Report" value="{{ $report->name }}">
                        </div>

                        <div class="form-group">
                            <label for="squareInput">DueTime</label>
                            <input type="datetime-local" class="form-control input-square" id="squareInput" name="duetime" value="{{ $report->duetime }}">
                            @error('duetime')
